...
export default function Client() {
  return (
    <div className="bg-light">
      ...
      <div className="col-lg-4 " ><img src={brilltech} height="75px"/></div>
      <div className="col-lg-4"><img src={djpl} height="75px"/></div>
      <div className="col-lg-4"><img src={traffic} height="75px"/></div>
      <div className="col-lg-4 mt-5  pt-5  pb-5"><img src={rpa} height="75px"/></div>
      <div className="col-lg-4 mt-5 pt-5 pb-5"><img src={xceltrip} height="75px"/></div>
      <div className="col-lg-4 mt-5 pt-5 pb-5"><img src={evolve} height="75px"/></div>
      </div>
      </div>
     </div>
  )
